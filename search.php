...
<html>
  ...
  <body>
    <div class="col-md-12" id="catagory" style="background-color:#006400;">
      <h3 style="padding-top:9px;">Your Desired Results</h3>
    </div>
    <?php
    ...
    if(isset($_POST['submit'])){
      $sr = $_POST['search'];
        $query = "Select PdfName,ImageName from bookshelf where BookName like '%" . $sr . "%'" ;
        $command= mysqli_query($connection,$query);
        while($row =mysqli_fetch_array($command))
        {
    ?>
        <div class="col-md-4" id="book" style="float:left;width:337px;padding-top:8px;padding-bottom:27px;">
